...
public class AddressRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8162995651048930349L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AddressRecord\",\"namespace\":\"avro\",\"fields\":[{\"name\":\"streetaddress\",\"type\":\"string\"},{\"name\":\"city\",\"type\":\"string\"},{\"name\":\"state\",\"type\":\"string\"},{\"name\":\"zip\",\"type\":\"string\"}]}");
   ...
   */
  public static avro.AddressRecord.Builder newBuilder() {
    return new avro.AddressRecord.Builder();
  }
   ...
   * @return A new AddressRecord RecordBuilder
   */
  public static avro.AddressRecord.Builder newBuilder(avro.AddressRecord.Builder other) {
    return new avro.AddressRecord.Builder(other);
  }
   ...
   * @return A new AddressRecord RecordBuilder
   */
  public static avro.AddressRecord.Builder newBuilder(avro.AddressRecord other) {
    return new avro.AddressRecord.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AddressRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.AddressRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.AddressRecord other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.streetaddress)) {
        this.streetaddress = data().deepCopy(fields()[0].schema(), other.streetaddress);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.AddressRecord.Builder setStreetaddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.AddressRecord.Builder clearStreetaddress() {
      streetaddress = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.AddressRecord.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.AddressRecord.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.AddressRecord.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.AddressRecord.Builder clearState() {
      state = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.AddressRecord.Builder setZip(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.AddressRecord.Builder clearZip() {
      zip = null;
